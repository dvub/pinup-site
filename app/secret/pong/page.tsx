...
export default function App() {
	...
	const [ball, setBall] = React.useState(initialBallState);
	const [paddles, setPaddles] = React.useState(initialPaddleState);
	...
	React.useEffect(() => {
		if (gameRunning) {
			...
			const updateGame = () => {
				...
				const paddleLeftRect = document
					.getElementById('paddle-left')
					.getBoundingClientRect();
				const paddleRightRect = document
					.getElementById('paddle-right')
					.getBoundingClientRect();
