...
export default function Navbar() {
	...
	return (
		<nav
			className={`${comfortaa.className} bg-white w-full lg:text-xl md:text-lg text-sm z-50 sticky top-0 pb-3`}
		...
		>
			...
			{width < breakpoints.medium && (
				<div>
					<div className='relative z-50 flex justify-between pt-5 px-5'>
						<Title />
						<button
							onClick={() => {
								setOpenNav(!openNav);
